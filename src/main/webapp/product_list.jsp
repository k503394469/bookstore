                ...
                <table cellspacing="0" class="listcontent">
                    <tr>
                        <td>
                            <h1>商品目录</h1>
                            <hr/>
                            <h1><%=request.getParameter("category")%>
                            </h1>&nbsp;&nbsp;&nbsp;&nbsp;共${requestScope.pb.totalCount}种商品
                            <hr/>
                            ...
                            <table cellspacing="0" cellpadding="1" rules="all"
                                ...
                                <c:forEach items="${requestScope.pb.objectList }" var="b">
                            ...
                            <div class="pagination">
                                <ul>
                                    <li class="nextpage"><a
                                            href="${pageContext.request.contextPath}/book/showBook?currentPage=${pb.currentPage==1?1:pb.currentPage-1}&category=${requestScope.category}">&lt;&lt;上一页</a>
                                    </li>

                                    <li>第${pb.currentPage}页/共${pb.totalPage}页</li>

                                    <li class="nextPage"><a
                                            href="${pageContext.request.contextPath}/book/showBook?currentPage=${pb.currentPage==pb.totalPage?pb.totalPage:pb.currentPage+1}&category=${requestScope.category}">下一页&gt;&gt;</a>
                                    </li>
                                </ul>
                            </div>
                        </td>
